...
function recommended(title) {
      ...
      var key = "NhwWyRiSxpnUEXKVulXqw"; // replace with your key
          var bookUrl = "https://www.goodreads.com/book/title.xml?&key=" + key + "&title=harry potter";
...
function parseXml1(xml) {
    ...
    $(xml).find('book:first').each(function() {
         ...
         $("#Container1").append("<div class='container'><div class='center'><div class='col-md-6 col-md-offset-3'><h2>" 
